...
const wardrobeBasics: WardrobeBasic[] = [
  { category: 'tees', label: 'white tee', detail: 'dense cotton. straight hem.', tone: 'paper' },
  { category: 'tees', label: 'black tee', detail: 'flat black. close neck.', tone: 'ink' },
  { category: 'tees', label: 'bone tee', detail: 'warmer cotton. dry hand.', tone: 'bone' },
  { category: 'tees', label: 'heather tee', detail: 'soft grey. quiet texture.', tone: 'smokeLight' },
  { category: 'tees', label: 'navy tee', detail: 'near-black. clean sleeve.', tone: 'smokeDark' },
  { category: 'tees', label: 'heavy tee', detail: 'boxier cut. no collapse.', tone: 'smokeMid' },
  { category: 'denim', label: 'raw denim', detail: 'rigid. architectural leg.', tone: 'ink' },
  { category: 'denim', label: 'indigo denim', detail: 'straight. worn dark.', tone: 'smokeDark' },
  { category: 'denim', label: 'washed denim', detail: 'pale cast. easy break.', tone: 'smokeLight' },
  { category: 'denim', label: 'black denim', detail: 'clean column. matte.', tone: 'smokeDark' },
  { category: 'denim', label: 'ecru denim', detail: 'dry cotton. no distress.', tone: 'bone' },
  { category: 'boots', label: 'chelsea boot', detail: 'brushed leather. narrow shaft.', tone: 'ink' },
  { category: 'boots', label: 'ankle boot', detail: 'stacked sole. polished toe.', tone: 'smokeDark' },
  { category: 'boots', label: 'field boot', detail: 'heavy tread. quiet hardware.', tone: 'power' },
  { category: 'shoes', label: 'white court shoe', detail: 'low profile. leather panels.', tone: 'paper' },
  { category: 'shoes', label: 'black loafer', detail: 'single line. no ornament.', tone: 'ink' },
  { category: 'shoes', label: 'suede runner', detail: 'panelled. muted sole.', tone: 'smokeMid' },
  { category: 'shoes', label: 'silver trainer', detail: 'technical skin. light sole.', tone: 'smokeLight' },
];
        ...
        >
          ...
          <View style={styles.blockFace}>
            <View style={styles.blockInner}>
              <View style={[styles.heroSwatch, toneStyles[active.tone]]} />
      ...
      >
        {wardrobeBasics.map((item, index) => {
          ...
          return (
            ...
            >
              <View style={[styles.railSwatch, toneStyles[item.tone]]} />
